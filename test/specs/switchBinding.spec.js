describe('When mySwitchComponent with data-jq-switch binding inited', function() {
    ...
    it('Then [data-jq-comp="mySwitchComponent"] should have render', function(done) {
        setTimeout(function() {
	...
	it('Should render only switch default case', function(done) {
        setTimeout(function() {
	...
	it('When selectedStory = s1 it then should render case1', function(done) {
		namespace.viewModel.onSelectedStory('s1');

        setTimeout(function() {
			var $case1 = document.getElementById('case1');
			var $storyTitle = $case1.querySelector('h4');
			var $storyImg = $case1.querySelector('img');
			var $storyDescription = $case1.querySelector('p');
	...
	it('When selectedStory = s2 it then should render case2 without image', function(done) {
		namespace.viewModel.onSelectedStory('s2');

        setTimeout(function() {
			var $case2 = document.getElementById('case2');
			var $storyTitle = $case2.querySelector('h4');
			var $storyImg = $case2.querySelector('img');
			var $storyDescription = $case2.querySelector('p');
	...
	it('When selectedStory non exists it then should render default case', function(done) {
		namespace.viewModel.onSelectedStory('xyz');

        setTimeout(function() {
			var $defaultCase = document.getElementById('default-case');
			var $defaultCaseTextContent = $defaultCase.querySelector('p').textContent;
			var defatulCaseText = 'No story found...';
